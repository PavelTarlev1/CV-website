...
function TechIcon({ tech }: { tech: string }) {
  switch (tech) {
    ...
    case 'GitHub Pages':   return <FaGithub />;
    case 'Python':         return <FaPython />;
    case 'PyQt5':          return <FaDesktop />;
    case 'PyInstaller':    return <FaDesktop />;
    case 'PyQt6':          return <FaDesktop />;
    case 'Bluetooth':      return <FaBluetooth />;
    case 'D-Bus':          return <FaNetworkWired />;
        ...
        {projects.map((project, index) => (
          ...
          >
            <div className="p-6">
              ...
              >
                {project.title}
                {project.ongoing && <CraneIcon size={32} color={theme.accent} />}
              </h3>
              ...
              <div className="flex gap-4">
                ...
                {project.liveDemoLink && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2 rounded-lg transition-colors duration-200"
                    style={{ backgroundColor: 'transparent', border: `1px solid ${theme.accent}`, color: theme.accent }}
